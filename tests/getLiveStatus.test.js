...
describe('getLiveStatus', () => {
  ...
  test('Campaign starts now and is unpublished', () => {
    const spoofedCampaign = createSpoofedCampaign(-1, 30 * 24 * 60, false);
    const status = getLiveStatus(spoofedCampaign);
  ...
  test('Campaign ends exactly now', () => {
    const spoofedCampaign = createSpoofedCampaign(
      -30 * 24 * 60,
      30 * 24 * 60,
      true,
  ...
  test('Campaign started and ended in the past', () => {
    const spoofedCampaign = createSpoofedCampaign(
      -60 * 24 * 60,
      30 * 24 * 60,
      true,
  ...
  test('Campaign starts in 1 hour', () => {
    const spoofedCampaign = createSpoofedCampaign(60, 30 * 24 * 60, true);
    const status = getLiveStatus(spoofedCampaign);
  ...
  test('Campaign starts in 30 days', () => {
    const spoofedCampaign = createSpoofedCampaign(
      30 * 24 * 60,
      30 * 24 * 60,
      true,
  ...
  test('Unpublished campaign in the past', () => {
    const spoofedCampaign = createSpoofedCampaign(
      -30 * 24 * 60,
      30 * 24 * 60,
      false,
  ...
  test('Unpublished campaign in the future', () => {
    const spoofedCampaign = createSpoofedCampaign(
      30 * 24 * 60,
      30 * 24 * 60,
      false,
  ...
  test('Campaign started exactly now', () => {
    const spoofedCampaign = createSpoofedCampaign(0, 30 * 24 * 60, true);
    const status = getLiveStatus(spoofedCampaign);
  ...
  test('Campaign ends exactly in 1 hour', () => {
    const spoofedCampaign = createSpoofedCampaign(
      -30 * 24 * 60 + 60, // Start 29 days, 23 hours, and 1 minute ago
      30 * 24 * 60, // Duration 30 days
      true,
    );
    const status = getLiveStatus(spoofedCampaign);
